<template>
  <div class="tk-admin-container">
    <div class="tk-admin" :class="{ '__show': show }" v-loading="loading">
      <a href="javascript:void(0)" class="tk-admin-close"  @click="onClose" v-html="iconClose"></a>
      ...
      <div v-if="!needUpdate">
        ...
        <div class="tk-panel" v-if="isLogin">
          <div class="tk-panel-title">
            ...
            <a href="javascript:void(0)" class="tk-panel-logout"  @click="onLogout">{{ t('ADMIN_LOGOUT') }}</a>
          </div>
          <div class="tk-tabs">
